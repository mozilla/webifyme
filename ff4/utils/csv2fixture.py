...
class QuizQuestion:
    ...
    def getFixture(self):
        self.fixture = ''
        self.fixture += "- fields: { question: \"" + self.question + "\" }\n"
...
class QuizAnswer:
    ...
    def getFixture(self):
        self.fixture = ''
        self.fixture += "- fields: { answer: \"" + self.answer + "\", quiz_question: " + str(self.question) + ", slug: \"" + str(self.pk) + "\" }\n"
        self.fixture += "  model: " + self.model + "\n"
        self.fixture += "  pk: " + str(self.pk) + "\n"
        return self.fixture
...
class QuizAnswerByImage:
    ...
    def getFixture(self):
        self.fixture = ''
        self.fixture += "- fields: { image: " + str(self.image) + ", answer: " + str(self.answer) + ", tooltip: \"" + self.tooltip + "\" }\n"
        self.fixture += "  model: " + self.model + "\n"
        self.fixture += "  pk: " + str(self.pk) + "\n"
        return self.fixture
...
class Image:
    ...
    def getFixture(self):
        self.fixture = ''
        self.fixture += "- fields: { file_name: \"" + self.file_name + "\", name: \"" + self.name + "\", slug: \"" + str(self.file_name) + "\" }\n"
        self.fixture += "  model: " + self.model + "\n"
        self.fixture += "  pk: " + str(self.pk) + "\n"
        return self.fixture
